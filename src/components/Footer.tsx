        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-center md:text-left">
            <div className="flex items-center space-x-3 justify-center md:justify-start mb-2">
              <div className="bg-gradient-to-br from-yellow-400 via-yellow-500 to-yellow-600 text-neutral-900 font-bold text-xl px-3 py-1 rounded-lg">
                AK
              </div>
              <span className="text-white font-bold text-lg">AK TRADERS</span>
            </div>
            <p className="text-gray-400 text-sm">ALL TYPES OF SCAFFOLDING MATERIAL SUPPLIERS</p>
          </div>
